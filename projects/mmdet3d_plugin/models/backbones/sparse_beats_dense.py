...
class SBD(nn.Module):
    ...
    #     if return_loss:
    #         return self.forward_train(mini_batch_data)
    #     else:
    #         return self.forward_test(mini_batch_data)
    ...
    def forward_net(self, img, radar, radar_pts, valid_radar_pts_cnts):
