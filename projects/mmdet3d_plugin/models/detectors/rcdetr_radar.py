...
class RCDETR_radar(MVXTwoStageDetector):
    """RCDETR."""
    ...
    def __init__(self,
        ...
        super(RCDETR_radar, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def extract_feat(self, img, radar, T, training_mode=False):
        ...
        if radar is not None and img is not None:
    ...
    def forward_train(self,
        ...
        rec_radar_feats = self.extract_feat(None, rec_radar, self.num_frame_backbone_grads)
    ...
    def simple_test_pts(self, img_metas, **data):
        ...
        if img_metas[0]['scene_token'] != self.prev_scene_token:
            ...
            data['prev_exists'] = data['radar'].new_zeros(1)
            self.pts_bbox_head.reset_memory()
        else:
            data['prev_exists'] = data['radar'].new_ones(1)
            pass
    ...
    def simple_test(self, img_metas, **data):
        ...
        rec_radar_feats = self.extract_feat(None, data['radar'], 1)
        # data['img_feats'] = rec_img_feats
        data['radar_feats'] = rec_radar_feats
