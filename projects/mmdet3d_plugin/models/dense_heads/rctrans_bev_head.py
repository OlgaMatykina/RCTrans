...
class RCTransBEVHead(AnchorFreeHead):
    ...
    def _rv_pe(self, img_feats, img_metas):
      ...
      # print('COORDS H, W, D SHAPES', coords_h.shape, coords_w.shape, coords_d.shape)
      ...
      # print('IMGS2LIDARS SHAPE', imgs2lidars.shape)
    ...
    def forward(self, memory_center, img_metas, topk_indexes=None,  **data):
      ...
      # print('RCTrans Head MEMORY RADAR SHAPE', memory_radar.shape)
      ...
      # print('RCTrans Head RV POS EMBED SHAPE', rv_pos_embed.shape)
        ...
        # print('BEV QUERY POS SHAPE', bev_query_pos.shape)
        # print('RV QUERY POS SHAPE', rv_query_pos.shape)
        ...
        # print('AFTER TEMP BEV QUERY POS SHAPE', bev_query_pos.shape)
        # print('AFTER TEMP RV QUERY POS SHAPE', rv_query_pos.shape)
