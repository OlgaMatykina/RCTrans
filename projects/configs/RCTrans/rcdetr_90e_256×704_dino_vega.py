...
dataset_type = 'CustomRadarCameraDataset'
data_root = '/home/docker_rctrans/HPR3/unpack_bags/'
ann_root = '/home/docker_rctrans/HPR3/unpack_bags/'
...
test_pipeline=[
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', keys=['img','radar', 'points'] + collect_keys,
            meta_keys=('filename', 'pts_filename', 'ori_shape', 'img_shape','pad_shape', 'scale_factor', 'flip', 'box_mode_3d', 'box_type_3d', 'img_norm_cfg', 'scene_token', 'lidar2img'))
        ]), 
]
...
data = dict(
    ...
    workers_per_gpu=0,
    test=dict(type=dataset_type, data_root=data_root, ann_file=ann_root + 'info.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality, test_mode=True),
