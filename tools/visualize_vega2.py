...
annroot='/home/docker_rctrans/HPR3/'
...
nusc = Vega(ann_file=annroot+'mini_vega_radar_temporal_infos_val.pkl', dataroot=dataroot, verbose=True, pred = True, annotations = result_json, score_thr=0.05)
